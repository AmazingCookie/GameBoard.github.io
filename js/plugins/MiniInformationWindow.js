...
/*:
 * @plugindesc (v1.03)[v1.1] 主菜单 - 详细信息窗口
 ...
 * -----------------------------------------------------------------------------
 * ----插件冲突
 * 该插件与yep物品核心插件相冲突，使得详细信息窗口可能无法弹出。
 *
 * -----------------------------------------------------------------------------
 * ----可选设定
                ...
                switch (trait.code) {
                    ...
                    case 11:
                        if ( DrillUp.m_attr_element_visible === "true") {
                            ...
                            text = c + ele + s + DrillUp.m_attr_element_text + du + 'x' + value * 100 + '%';
                        }
                        break;
                    case 112:
                    case 12:
                        if ( DrillUp.m_attr_weak_visible === "true") {
                            ...
                            text = c + param + s + DrillUp.m_attr_weak_text + du + 'x' + value * 100 + '%';
                        }
                        break;
                    case 113:
                    case 13:
                        if ( DrillUp.m_attr_state_visible === "true") {
                            ...
                            text = c + state + s + DrillUp.m_attr_state_text + du + 'x' + value * 100 + '%';
                        }
                        break;
                    case 114:
                    case 14:
                    ...
                    case 121:
                    case 21:
                        if ( DrillUp.m_attr_common_visible === "true" && value !== 1.0) {
                            var param = TextManager.param(dataId);
                    ...
                    case 43:
                        if (DrillUp.m_attr_skill2_visible === "true" ){
                            text = s + DrillUp.m_attr_skill2_text + c + skill.name;
                        }
                        break;
                    case 44:
                        if (DrillUp.m_attr_skill3_visible === "true" ){
                            text = s + DrillUp.m_attr_skill3_text + c + skill.name;
                        }
                        break;
                    case 51:
    ...
    Window_MiniInfo.prototype.refresh = function() {
        ...
        if (this.exRow()) {
			...
			if(DrillUp.m_window_black === "true"){
				this.contents.fillRect(0, 0 , this.contentsWidth(), this.contentsHeight(), this.textColor(15));//背景黑框
			}
            ...
            this.contents.fillRect(4, fs + 15, this.contentsWidth() - 8, 2, this.textColor(DrillUp.iter_color));
